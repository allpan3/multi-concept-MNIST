...
def get_test_data(root, vsa = None, shuffle = False, num_samples = 100, max_num_objects = 3, single_count = False, batch_size = 1, num_pos_x = 3, num_pos_y = 3, num_colors = 7, transform = None):
    ...
    test_dl = DataLoader(test_ds, batch_size=batch_size, shuffle=shuffle, collate_fn=collate_test_fn)
    return test_dl